...
<div class="container mt-4">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/blog-grid.jpg" height="450px" class="d-block w-100" alt="">
    </div>
    <div class="carousel-item">
      <img src="img/bloodhome2.png" height="450px"  class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/bloodimg.png" height="450px"  class="d-block w-100" alt="...">
    </div>
  </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
    ...
    <div class="container mt-4">
    <div class="row">
        <!-- <div class="col-md-4 shadow main-blog-post m-0"> -->
    ...
    <div class="container mt-4">
        <div class="row g-1">
        <?php include('includes/blog/all-posts.php') ?>
        </div>
    </div>
