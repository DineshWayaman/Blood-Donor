...
if ($status==0) {
  ...
  $getPost = "SELECT * FROM `blog` WHERE `b_id`=$postID";
...
<body>
    ...
    <form action="../../config/sqlcodes.php" method="post">
    <div class="form-group mt-2">
      <input type="hidden" name="bid" value="<?php echo $postID ?>">
    <label for="inputAddress">Title</label>
    <input type="text" name="title" class="form-control" id="inputAddress" value="<?php echo $postfetch['b_title'] ?>">
    </div>
    <div class="form-group mt-2">
    <label for="inputAddress">Slug</label>
    <input type="text" name="slug" class="form-control" id="inputAddress" value="<?php echo $postfetch['b_slug'] ?>">
    </div>
  <div class="form-group mt-2">
    <label for="inputAddress2">Meta Description</label>
    <textarea type="text" name="meta" class="form-control" id="inputAddress2" style="max-height: 100px; min-height: 100px;"><?php echo $postfetch['b_metadesc'] ?></textarea>
  </div>
  <div class="form-group mt-2">
    <label for="inputAddress2">Content</label>
    <textarea type="text" name="content" class="form-control" id="content" placeholder=""><?php echo $postfetch['b_content'] ?></textarea>
  </div>
